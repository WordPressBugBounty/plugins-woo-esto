...
class WC_Pay_Later_Payment extends WC_Esto_Payment 
{
    ...
    public function __construct() {
        ...
        $this->min_amount = (float) $this->get_option('min_amount', 0.1); // Use inherited property
        $this->max_amount = (float) $this->get_option('max_amount', 10000); // Use inherited property
    }
