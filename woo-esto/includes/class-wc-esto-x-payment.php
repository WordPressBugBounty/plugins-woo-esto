...
class WC_Esto_X_Payment extends WC_Esto_Payment
{
	...
	protected string $show_calculator;
	...
	public function __construct()
	{
		...
		// Explicitly declare schedule_type and show_calculator.
		...
		$this->form_fields = array_merge(
			[
				...
				'show_calculator' => [
					...
					'type' => 'checkbox',
					'label' => __('Show calculator in the payment method\'s description area in checkout.', 'woo-esto'),
					'default' => 'no',
				]
			],
